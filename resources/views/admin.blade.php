    ...
    <div ng-controller="AdminCtrl" class="ng-root">
        <div class='col-md-2'>
            <ul class='nav nav-pills nav-stacked admin-nav' role='tablist'>
                ...
                @endif
                <li role='presentation' aria-controls="settings" class='admin-nav-item'><a href='#settings'>Settings</a>
                </li>
                @if ($role == $admin_role)
        ...
        <div class='col-md-10'>
            <div class="tab-content">
                ...
                <div role="tabpanel" class="tab-pane" id="settings">
                    ...
                    @if (empty(session('saml')))
                        <form action='/admin/action/change_password' method='POST'>
                            Old Password: <input class="form-control password-box" type='password'
                    ...
                    @else
                        <p>This account is managed. Password reset is unavailable here.</p>
                    @endif
                </div>
                @if ($role == $admin_role)
                    <div role="tabpanel" class="tab-pane" id="adminLinke">
                        <h3>Links</h3>
                        @include('snippets.link_table', [
                    ...
                    <div role="tabpanel" class="tab-pane" id="admin">
                        ...
                        <a ng-click="state.showNewUserWell = !state.showNewUserWell"
                           class="btn btn-primary btn-sm status-display">New</a>
                            ...
                            <table class="table">
                                ...
                                <tr id="new-user-form">
                                    ...
                                    <td><input type="password" class="form-control"
                                               ng-model="newUserParams.userPassword"></td>
                                    <td><input type="email" class="form-control" ng-model="newUserParams.userEmail">
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <a ng-click="addNewUser($event)"
                                           class="btn btn-primary btn-sm status-display new-user-add">Add</a>
                                    </td>
                                </tr>
                            </table>
                        </div>
                ...
                @if ($api_active == 1)
                    <div role="tabpanel" class="tab-pane" id="developer">
                        ...
                        <div class='row'>
                            ...
                            <div class='col-md-4'>
                                <a href='#' ng-click="generateNewAPIKey($event, '{{$user_id}}', true)"
                                   id='api-reset-key' class='btn btn-danger'>Reset</a>
                            </div>
                        </div>
        ...
        <div class="angular-modals">
            ...
            <edit-user-api-info-modal ng-repeat="modal in modals.editUserApiInfo" user-id="modal.userId"
                                      ...
                                      generate-new-api-key="generateNewAPIKey"
                                      clean-modals="cleanModals"></edit-user-api-info>
        </div>
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-xs-12 center-block text-center">Right click the QR code and select Save As
                            </div>
