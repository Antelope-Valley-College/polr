...
# Blank for local accounts only. SAML for SAML auth.
POLR_LOGIN_MODES="{{$POLR_LOGIN_MODES}}"

@if(in_array('SAML',explode(',',$POLR_LOGIN_MODES)))
SAML_PRIMARY_LOGIN="{{$SAML_PRIMARY_LOGIN}}"
SAML_ENTITYID="{{$SAML_ENTITYID}}"
SAML_SERVICE_NAME="{{$SAML_SERVICE_NAME}}"
SAML_SERVICE_DESC="{{$SAML_SERVICE_DESC}}"
